...
public abstract class Enemy extends Agent {
    ...
    public void updateLoc(Tilemap tilemap, boolean playerLeft, boolean playerRight,
                          boolean playerUp, boolean playerDown, boolean standStill, boolean
                                  collideCheck) {
        this.movementBehavior.moveEnemy(tilemap, this.location, playerLeft, playerUp,
                standStill, collideCheck);
